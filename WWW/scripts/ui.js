// ui.js (تمیز شده - بدون توابع داشبورد)
        ...
        if (pageName !== 'login') {
            ...
            if (!sidebarLoaded) {
                ...
                if (sidebarContainer) {
                    ...
                    // منتظر کامل شدن getUserInfo می‌مانیم
                    await getUserInfo();
                }
            } else {
                // اگر sidebar قبلاً لود شده، باز هم منتظر getUserInfo می‌مانیم
                await getUserInfo();
            }
            ...
            if (container) {
                ...
                if (pageName === 'dashboard') {
                    ...
                    setupAssignedNumbersListner();
                } else if (pageName === 'bulk-assign-number') { // اضافه شده
                    setupBulkAssignPageListeners();
...
// توابع سراسری برای عملیات داشبورد
